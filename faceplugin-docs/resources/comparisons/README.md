---
description: >-
  On-premise face recognition and liveness SDK comparison. Faceplugin versus 3DiVi, FaceTec,
  Luxand, FaceOnLive, and KBY-AI. Criteria from public vendor docs, not guessed checkmarks.
---

# On-premise face recognition and liveness SDK comparison
...
| --- | --- |
| [Faceplugin vs 3DiVi](vs-3divi.md) | Cross-platform face SDK, C++ core, liveness estimator |
| [Faceplugin vs FaceTec](vs-facetec.md) | 3D liveness / FaceMap KYC vs 2D on-prem SDK suite |
| [Faceplugin vs Luxand](vs-luxand.md) | Classic FaceSDK vs Faceplugin + document products |
