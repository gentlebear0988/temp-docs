...
description: >-
  ...
  catalogs, APIs, and what Faceplugin products in these docs actually implement.
---
...
| Flutter / React Native | FR + Document yes; Liveness no Flutter/React Native SDK | Vendor site lists Flutter and RN |
...
| Passive face anti-spoofing | Yes | Yes (vendor site; Level 2 claims — verify) |
| Passport OCR / MRZ | Yes | Yes (vendor site) |
| Document liveness | Yes (Linux) | Yes (vendor GitHub/docs) |
| Combined eKYC package | You combine products yourself ([choose a product](../choose-a-product.md)) | Vendor markets a suite |
